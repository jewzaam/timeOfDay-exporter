            ...
            try:
                ...
                if 'results' in data:
                    for key in data['results']:
                        ...
                        utility.set("timeOfDay_{}".format(key), epoch_time, global_labels)
                ...
                utility.set("timeOfDay_begin_day",begin_day,global_labels)
                utility.set("timeOfDay_begin_night",begin_night,global_labels)

                utility.inc("timeOfDay_success_total", global_labels)
            except Exception as e:
                # well something went bad
                print(repr(e))
                traceback.print_exc()
                utility.inc("timeOfDay_error_total", global_labels)
